...
# mark_description "-S -qopenmp -xCOMMON-AVX512 -fno-alias -o MatMatMultiplyBlockHelper.AVX512.NoAliases.s";
...
..B1.2:                         # Preds ..B1.4 ..B1.1
        ...
        xorl      %r8d, %r8d                                    #7.9
        vmovups   128(%rax,%rdx), %zmm1                         #10.13
        vmovups   64(%rax,%rdx), %zmm0                          #10.13
        vmovups   (%rax,%rdx), %zmm2                            #10.13
        .align    16,0x90
